function init(){
    ...
    for (var i = 0; i < jogador_1.obeliscos_equipados.length; i++){
        jogador_1.usar_obelisco(jogador_1.obeliscos_equipados[i], jogador_2);
    }
    for (var i = 0; i < jogador_2.obeliscos_equipados.length; i++){
        jogador_1.usar_obelisco(jogador_2.obeliscos_equipados[i], jogador_1);
    }
